...
- (void)viewDidLoad {
    ...
    [self setupGLProgram];
    [self setupTexture:@"spot_texture"];
...
- (void)glkView:(GLKView *)view drawInRect:(CGRect)rect {
    ...
    GLuint coordinate = glGetAttribLocation(self.programId, "coordinate");
    glEnableVertexAttribArray(coordinate);
    glBindBuffer(GL_ARRAY_BUFFER, self.uvBufferAttr);
    glVertexAttribPointer(coordinate, 2, GL_FLOAT, GL_FALSE, sizeof(float) * 2, NULL);
